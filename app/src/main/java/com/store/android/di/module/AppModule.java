...
import com.store.android.BuildConfig;
import com.store.android.constant.Constants;
import com.store.android.data.AppRepository;
import com.store.android.data.Repository;
import com.store.android.data.local.prefs.AppPreferencesService;
import com.store.android.data.local.prefs.PreferencesService;
import com.store.android.data.local.room.AppDatabase;
import com.store.android.data.local.room.AppDbService;
import com.store.android.data.local.room.RoomService;
import com.store.android.data.remote.ApiService;
import com.store.android.data.remote.AuthInterceptor;
import com.store.android.di.qualifier.ApiInfo;
import com.store.android.di.qualifier.DatabaseInfo;
import com.store.android.di.qualifier.PreferenceInfo;
